...
class Izuru_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen1/Kanade Izuru/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_izuru)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_izuru)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.KanadeIzuru_Name)
        ageView = findViewById(R.id.KanadeIzuru_Age)
        birthday = findViewById(R.id.KanadeIzuru_Birth)
        debut = findViewById(R.id.KanadeIzuru_Debut)
        height = findViewById(R.id.KanadeIzuru_Height)
        gender = findViewById(R.id.KanadeIzuru_Gender)
        profDesc = findViewById(R.id.KanadeIzuru_ProfDesc)
