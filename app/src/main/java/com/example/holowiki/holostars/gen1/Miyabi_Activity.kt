...
class Miyabi_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen1/Hanasaki Miyabi/Profile")
        ...
        talent_name = findViewById(R.id.HanasakiMiyabi_Name)
        ageView = findViewById(R.id.HanasakiMiyabi_Age)
        birthday = findViewById(R.id.HanasakiMiyabi_Birth)
        debut = findViewById(R.id.HanasakiMiyabi_Debut)
        height = findViewById(R.id.HanasakiMiyabi_Height)
        gender = findViewById(R.id.HanasakiMiyabi_Gender)
        profDesc = findViewById(R.id.HanasakiMiyabi_ProfDesc)
