...
class Tenma_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen2/Kishido Tenma/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tenma)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_tenma)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.KishidoTenma_Name)
        ageView = findViewById(R.id.KishidoTenma_Age)
        birthday = findViewById(R.id.KishidoTenma_Birth)
        debut = findViewById(R.id.KishidoTenma_Debut)
        height = findViewById(R.id.KishidoTenma_Height)
        gender = findViewById(R.id.KishidoTenma_Gender)
        profDesc = findViewById(R.id.KishidoTenma_ProfDesc)
