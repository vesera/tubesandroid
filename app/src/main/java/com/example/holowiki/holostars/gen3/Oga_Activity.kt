...
class Oga_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen3/Aragami Oga/Profile")
        ...
        talent_name = findViewById(R.id.AragamiOga_Name)
        ageView = findViewById(R.id.AragamiOga_Age)
        birthday = findViewById(R.id.AragamiOga_Birth)
        debut = findViewById(R.id.AragamiOga_Debut)
        height = findViewById(R.id.AragamiOga_Height)
        gender = findViewById(R.id.AragamiOga_Gender)
        profDesc = findViewById(R.id.AragamiOga_ProfDesc)
