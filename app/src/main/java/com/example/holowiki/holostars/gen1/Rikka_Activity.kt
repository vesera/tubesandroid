...
class Rikka_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen1/Rikka/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_rikka)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_rikka)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.Rikka_Name)
        ageView = findViewById(R.id.Rikka_Age)
        birthday = findViewById(R.id.Rikka_Birth)
        debut = findViewById(R.id.Rikka_Debut)
        height = findViewById(R.id.Rikka_Height)
        gender = findViewById(R.id.Rikka_Gender)
        profDesc = findViewById(R.id.Rikka_ProfDesc)
