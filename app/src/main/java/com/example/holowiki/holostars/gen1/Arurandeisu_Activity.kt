...
class Arurandeisu_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen1/Arurandeisu/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_arurandeisu)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_arurandeisu)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.Arurandeisu_Name)
        ageView = findViewById(R.id.Arurandeisu_Age)
        birthday = findViewById(R.id.Arurandeisu_Birth)
        debut = findViewById(R.id.Arurandeisu_Debut)
        height = findViewById(R.id.Arurandeisu_Height)
        gender = findViewById(R.id.Arurandeisu_Gender)
        profDesc = findViewById(R.id.Arurandeisu_ProfDesc)
