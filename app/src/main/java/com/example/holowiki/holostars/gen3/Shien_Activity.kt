...
class Shien_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen3/Kageyama Shien/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_shien)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_shien)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.KageyamaShien_Name)
        ageView = findViewById(R.id.KageyamaShien_Age)
        birthday = findViewById(R.id.KageyamaShien_Birth)
        debut = findViewById(R.id.KageyamaShien_Debut)
        height = findViewById(R.id.KageyamaShien_Height)
        gender = findViewById(R.id.KageyamaShien_Gender)
        profDesc = findViewById(R.id.KageyamaShien_ProfDesc)
