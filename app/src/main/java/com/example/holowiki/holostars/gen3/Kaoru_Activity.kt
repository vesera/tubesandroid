...
class Kaoru_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen3/Tsukishita Kaoru/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kaoru)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_kaoru)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.TsukishitaKaoru_Name)
        ageView = findViewById(R.id.TsukishitaKaoru_Age)
        birthday = findViewById(R.id.TsukishitaKaoru_Birth)
        debut = findViewById(R.id.TsukishitaKaoru_Debut)
        height = findViewById(R.id.TsukishitaKaoru_Height)
        gender = findViewById(R.id.TsukishitaKaoru_Gender)
        profDesc = findViewById(R.id.TsukishitaKaoru_ProfDesc)
