...
class Suzaku_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen1/Yakushiji Suzaku/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_suzaku)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_suzaku)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.YakushijiSuzaku_Name)
        ageView = findViewById(R.id.YakushijiSuzaku_Age)
        birthday = findViewById(R.id.YakushijiSuzaku_Birth)
        debut = findViewById(R.id.YakushijiSuzaku_Debut)
        height = findViewById(R.id.YakushijiSuzaku_Height)
        gender = findViewById(R.id.YakushijiSuzaku_Gender)
        profDesc = findViewById(R.id.YakushijiSuzaku_ProfDesc)
