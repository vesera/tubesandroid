...
class Kira_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen1/Kagami Kira/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kira)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_kira)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.KagamiKira_Name)
        ageView = findViewById(R.id.KagamiKira_Age)
        birthday = findViewById(R.id.KagamiKira_Birth)
        debut = findViewById(R.id.KagamiKira_Debut)
        height = findViewById(R.id.KagamiKira_Height)
        gender = findViewById(R.id.KagamiKira_Gender)
        profDesc = findViewById(R.id.KagamiKira_ProfDesc)
