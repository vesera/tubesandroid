...
class Astel_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen2/Astel Leda/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_astel)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_astel)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.AstelLeda_Name)
        ageView = findViewById(R.id.AstelLeda_Age)
        birthday = findViewById(R.id.AstelLeda_Birth)
        debut = findViewById(R.id.AstelLeda_Debut)
        height = findViewById(R.id.AstelLeda_Height)
        gender = findViewById(R.id.AstelLeda_Gender)
        profDesc = findViewById(R.id.AstelLeda_ProfDesc)
