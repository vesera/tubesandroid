...
class Roberu_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Holostars/Talents/Holostars/Gen2/Yukoku Roberu/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_roberu)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_roberu)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.YukokuRoberu_Name)
        ageView = findViewById(R.id.YukokuRoberu_Age)
        birthday = findViewById(R.id.YukokuRoberu_Birth)
        debut = findViewById(R.id.YukokuRoberu_Debut)
        height = findViewById(R.id.YukokuRoberu_Height)
        gender = findViewById(R.id.YukokuRoberu_Gender)
        profDesc = findViewById(R.id.YukokuRoberu_ProfDesc)
