...
class Fubuki_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen1/Shirakami Fubuki/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fubuki)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_fubuki)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.ShirakamiFubuki_Name)
        ageView = findViewById(R.id.ShirakamiFubuki_Age)
        birthday = findViewById(R.id.ShirakamiFubuki_Birth)
        debut = findViewById(R.id.ShirakamiFubuki_Debut)
        height = findViewById(R.id.ShirakamiFubuki_Height)
        gender = findViewById(R.id.ShirakamiFubuki_Gender)
        profDesc = findViewById(R.id.ShirakamiFubuki_ProfDesc)
