...
class Sora_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen0/Tokino Sora/Profile")
        ...
        talent_name = findViewById(R.id.TokinoSora_Name)
        ageView = findViewById(R.id.TokinoSora_Age)
        birthday = findViewById(R.id.TokinoSora_Birth)
        debut = findViewById(R.id.TokinoSora_Debut)
        height = findViewById(R.id.TokinoSora_Height)
        gender = findViewById(R.id.TokinoSora_Gender)
        profDesc = findViewById(R.id.TokinoSora_ProfDesc)
