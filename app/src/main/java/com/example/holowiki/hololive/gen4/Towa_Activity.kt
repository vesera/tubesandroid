...
class Towa_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen4/Tokoyami Towa/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_towa)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_towa)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.TokoyamiTowa_Name)
        ageView = findViewById(R.id.TokoyamiTowa_Age)
        birthday = findViewById(R.id.TokoyamiTowa_Birth)
        debut = findViewById(R.id.TokoyamiTowa_Debut)
        height = findViewById(R.id.TokoyamiTowa_Height)
        gender = findViewById(R.id.TokoyamiTowa_Gender)
        profDesc = findViewById(R.id.TokoyamiTowa_ProfDesc)
