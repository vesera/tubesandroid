...
class Rushia_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen3/Uruha Rushia/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_rushia)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_rushia)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.UruhaRushia_Name)
        ageView = findViewById(R.id.UruhaRushia_Age)
        birthday = findViewById(R.id.UruhaRushia_Birth)
        debut = findViewById(R.id.UruhaRushia_Debut)
        height = findViewById(R.id.UruhaRushia_Height)
        gender = findViewById(R.id.UruhaRushia_Gender)
        profDesc = findViewById(R.id.UruhaRushia_ProfDesc)
