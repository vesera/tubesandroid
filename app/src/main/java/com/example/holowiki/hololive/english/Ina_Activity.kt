...
class Ina_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/English/Ninomae Ina'nis/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_ina)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.NinomaeInanis_Name)
        ageView = findViewById(R.id.NinomaeInanis_Age)
        birthday = findViewById(R.id.NinomaeInanis_Birth)
        debut = findViewById(R.id.NinomaeInanis_Debut)
        height = findViewById(R.id.NinomaeInanis_Height)
        gender = findViewById(R.id.NinomaeInanis_Gender)
        profDesc = findViewById(R.id.NinomaeInanis_ProfDesc)
