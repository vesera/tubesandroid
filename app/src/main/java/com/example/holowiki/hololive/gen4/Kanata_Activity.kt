...
class Kanata_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen4/Amane Kanata/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kanata)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_kanata)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.AmaneKanata_Name)
        ageView = findViewById(R.id.AmaneKanata_Age)
        birthday = findViewById(R.id.AmaneKanata_Birth)
        debut = findViewById(R.id.AmaneKanata_Debut)
        height = findViewById(R.id.AmaneKanata_Height)
        gender = findViewById(R.id.AmaneKanata_Gender)
        profDesc = findViewById(R.id.AmaneKanata_ProfDesc)
