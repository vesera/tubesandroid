...
class Roboco_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen0/Roboco/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_roboco)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_roboco)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.Roboco_Name)
        ageView = findViewById(R.id.Roboco_Age)
        birthday = findViewById(R.id.Roboco_Birth)
        debut = findViewById(R.id.Roboco_Debut)
        height = findViewById(R.id.Roboco_Height)
        gender = findViewById(R.id.Roboco_Gender)
        profDesc = findViewById(R.id.Roboco_ProfDesc)
