...
class Moona_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/ID Gen1/Moona Hoshinova/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_moona)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_moona)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.MoonaHoshinova_Name)
        ageView = findViewById(R.id.MoonaHoshinova_Age)
        birthday = findViewById(R.id.MoonaHoshinova_Birth)
        debut = findViewById(R.id.MoonaHoshinova_Debut)
        height = findViewById(R.id.MoonaHoshinova_Height)
        gender = findViewById(R.id.MoonaHoshinova_Gender)
        profDesc = findViewById(R.id.MoonaHoshinova_ProfDesc)
