...
class Kiara_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/English/Takanashi Kiara/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_kiara)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_kiara)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.TakanashiKiara_Name)
        ageView = findViewById(R.id.TakanashiKiara_Age)
        birthday = findViewById(R.id.TakanashiKiara_Birth)
        debut = findViewById(R.id.TakanashiKiara_Debut)
        height = findViewById(R.id.TakanashiKiara_Height)
        gender = findViewById(R.id.TakanashiKiara_Gender)
        profDesc = findViewById(R.id.TakanashiKiara_ProfDesc)
