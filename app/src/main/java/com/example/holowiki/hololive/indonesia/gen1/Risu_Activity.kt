...
class Risu_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/ID Gen1/Ayunda Risu/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_risu)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_risu)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.AyundaRisu_Name)
        ageView = findViewById(R.id.AyundaRisu_Age)
        birthday = findViewById(R.id.AyundaRisu_Birth)
        debut = findViewById(R.id.AyundaRisu_Debut)
        height = findViewById(R.id.AyundaRisu_Height)
        gender = findViewById(R.id.AyundaRisu_Gender)
        profDesc = findViewById(R.id.AyundaRisu_ProfDesc)
