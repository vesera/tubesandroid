...
class Watame_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen4/Tsunomaki Watame/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_watame)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_watame)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.TsunomakiWatame_Name)
        ageView = findViewById(R.id.TsunomakiWatame_Age)
        birthday = findViewById(R.id.TsunomakiWatame_Birth)
        debut = findViewById(R.id.TsunomakiWatame_Debut)
        height = findViewById(R.id.TsunomakiWatame_Height)
        gender = findViewById(R.id.TsunomakiWatame_Gender)
        profDesc = findViewById(R.id.TsunomakiWatame_ProfDesc)
