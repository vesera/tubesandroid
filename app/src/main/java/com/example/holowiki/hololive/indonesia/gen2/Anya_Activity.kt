...
class Anya_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/ID Gen2/Anya Melfissa/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_anya)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.AnyaMelfissa_Name)
        ageView = findViewById(R.id.AnyaMelfissa_Age)
        birthday = findViewById(R.id.AnyaMelfissa_Birth)
        debut = findViewById(R.id.AnyaMelfissa_Debut)
        height = findViewById(R.id.AnyaMelfissa_Height)
        gender = findViewById(R.id.AnyaMelfissa_Gender)
        profDesc = findViewById(R.id.AnyaMelfissa_ProfDesc)
