...
class Subaru_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen2/Oozora Subaru/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_subaru)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.OozoraSubaru_Name)
        ageView = findViewById(R.id.OozoraSubaru_Age)
        birthday = findViewById(R.id.OozoraSubaru_Birth)
        debut = findViewById(R.id.OozoraSubaru_Debut)
        height = findViewById(R.id.OozoraSubaru_Height)
        gender = findViewById(R.id.OozoraSubaru_Gender)
        profDesc = findViewById(R.id.OozoraSubaru_ProfDesc)
