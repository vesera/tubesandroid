...
class Polka_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen5/Omaru Polka/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_polka)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_polka)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.OmaruPolka_Name)
        ageView = findViewById(R.id.OmaruPolka_Age)
        birthday = findViewById(R.id.OmaruPolka_Birth)
        debut = findViewById(R.id.OmaruPolka_Debut)
        height = findViewById(R.id.OmaruPolka_Height)
        gender = findViewById(R.id.OmaruPolka_Gender)
        profDesc = findViewById(R.id.OmaruPolka_ProfDesc)
