...
class Choco_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen2/Yuzuki Choco/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_choco)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.YuzukiChoco_Name)
        ageView = findViewById(R.id.YuzukiChoco_Age)
        birthday = findViewById(R.id.YuzukiChoco_Birth)
        debut = findViewById(R.id.YuzukiChoco_Debut)
        height = findViewById(R.id.YuzukiChoco_Height)
        gender = findViewById(R.id.YuzukiChoco_Gender)
        profDesc = findViewById(R.id.YuzukiChoco_ProfDesc)
