...
class Coco_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen4/Kiryuu Coco/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_coco)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.KiryuuCoco_Name)
        ageView = findViewById(R.id.KiryuuCoco_Age)
        birthday = findViewById(R.id.KiryuuCoco_Birth)
        debut = findViewById(R.id.KiryuuCoco_Debut)
        height = findViewById(R.id.KiryuuCoco_Height)
        gender = findViewById(R.id.KiryuuCoco_Gender)
        profDesc = findViewById(R.id.KiryuuCoco_ProfDesc)
