...
class Suisei_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen0/Hoshimachi Suisei/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_suisei)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_suisei)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.HoshimachiSuisei_Name)
        ageView = findViewById(R.id.HoshimachiSuisei_Age)
        birthday = findViewById(R.id.HoshimachiSuisei_Birth)
        debut = findViewById(R.id.HoshimachiSuisei_Debut)
        height = findViewById(R.id.HoshimachiSuisei_Height)
        gender = findViewById(R.id.HoshimachiSuisei_Gender)
        profDesc = findViewById(R.id.HoshimachiSuisei_ProfDesc)
