...
class Botan_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen5/Shishiro Botan/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_botan)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_botan)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.ShishiroBotan_Name)
        ageView = findViewById(R.id.ShishiroBotan_Age)
        birthday = findViewById(R.id.ShishiroBotan_Birth)
        debut = findViewById(R.id.ShishiroBotan_Debut)
        height = findViewById(R.id.ShishiroBotan_Height)
        gender = findViewById(R.id.ShishiroBotan_Gender)
        profDesc = findViewById(R.id.ShishiroBotan_ProfDesc)
