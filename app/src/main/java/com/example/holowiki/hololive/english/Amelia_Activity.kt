...
class Amelia_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/English/Amelia Watson/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_amelia)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_sora)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.AmeliaWatson_Name)
        ageView = findViewById(R.id.AmeliaWatson_Age)
        birthday = findViewById(R.id.AmeliaWatson_Birth)
        debut = findViewById(R.id.AmeliaWatson_Debut)
        height = findViewById(R.id.AmeliaWatson_Height)
        gender = findViewById(R.id.AmeliaWatson_Gender)
        profDesc = findViewById(R.id.AmeliaWatson_ProfDesc)
