...
class Lamy_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen5/Yukihana Lamy/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lamy)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_lamy)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.YukihanaLamy_Name)
        ageView = findViewById(R.id.YukihanaLamy_Age)
        birthday = findViewById(R.id.YukihanaLamy_Birth)
        debut = findViewById(R.id.YukihanaLamy_Debut)
        height = findViewById(R.id.YukihanaLamy_Height)
        gender = findViewById(R.id.YukihanaLamy_Gender)
        profDesc = findViewById(R.id.YukihanaLamy_ProfDesc)
