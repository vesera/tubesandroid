...
class Reine_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/ID Gen2/Pavolia Reine/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_reine)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_reine)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.PavoliaReine_Name)
        ageView = findViewById(R.id.PavoliaReine_Age)
        birthday = findViewById(R.id.PavoliaReine_Birth)
        debut = findViewById(R.id.PavoliaReine_Debut)
        height = findViewById(R.id.PavoliaReine_Height)
        gender = findViewById(R.id.PavoliaReine_Gender)
        profDesc = findViewById(R.id.PavoliaReine_ProfDesc)
