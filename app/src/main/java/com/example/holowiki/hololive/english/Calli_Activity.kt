...
class Calli_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/English/Mori Calliope/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_calli)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_calli)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.MoriCalliope_Name)
        ageView = findViewById(R.id.MoriCalliope_Age)
        birthday = findViewById(R.id.MoriCalliope_Birth)
        debut = findViewById(R.id.MoriCalliope_Debut)
        height = findViewById(R.id.MoriCalliope_Height)
        gender = findViewById(R.id.MoriCalliope_Gender)
        profDesc = findViewById(R.id.MoriCalliope_ProfDesc)
