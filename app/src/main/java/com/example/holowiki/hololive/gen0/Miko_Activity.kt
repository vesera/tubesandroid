...
class Miko_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen0/Sakura Miko/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_miko)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_miko)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.SakuraMiko_Name)
        ageView = findViewById(R.id.SakuraMiko_Age)
        birthday = findViewById(R.id.SakuraMiko_Birth)
        debut = findViewById(R.id.SakuraMiko_Debut)
        height = findViewById(R.id.SakuraMiko_Height)
        gender = findViewById(R.id.SakuraMiko_Gender)
        profDesc = findViewById(R.id.SakuraMiko_ProfDesc)
