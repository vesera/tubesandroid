...
class Aki_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen1/Aki Rosenthal/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_aki)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.AkiRosenthal_Name)
        ageView = findViewById(R.id.AkiRosenthal_Age)
        birthday = findViewById(R.id.AkiRosenthal_Birth)
        debut = findViewById(R.id.AkiRosenthal_Debut)
        height = findViewById(R.id.AkiRosenthal_Height)
        gender = findViewById(R.id.AkiRosenthal_Gender)
        profDesc = findViewById(R.id.AkiRosenthal_ProfDesc)
