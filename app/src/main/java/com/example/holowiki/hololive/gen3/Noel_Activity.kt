...
class Noel_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen3/Shirogane Noel/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_noel)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.ShiroganeNoel_Name)
        ageView = findViewById(R.id.ShiroganeNoel_Age)
        birthday = findViewById(R.id.ShiroganeNoel_Birth)
        debut = findViewById(R.id.ShiroganeNoel_Debut)
        height = findViewById(R.id.ShiroganeNoel_Height)
        gender = findViewById(R.id.ShiroganeNoel_Gender)
        profDesc = findViewById(R.id.ShiroganeNoel_ProfDesc)
