...
class Gura_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/English/Gawr Gura/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_gura)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.GawrGura_Name)
        ageView = findViewById(R.id.GawrGura_Age)
        birthday = findViewById(R.id.GawrGura_Birth)
        debut = findViewById(R.id.GawrGura_Debut)
        height = findViewById(R.id.GawrGura_Height)
        gender = findViewById(R.id.GawrGura_Gender)
        profDesc = findViewById(R.id.GawrGura_ProfDesc)
