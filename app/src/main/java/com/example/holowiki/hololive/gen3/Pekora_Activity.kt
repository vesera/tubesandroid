...
class Pekora_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen3/Usada Pekora/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pekora)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_pekora)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.UsadaPekora_Name)
        ageView = findViewById(R.id.UsadaPekora_Age)
        birthday = findViewById(R.id.UsadaPekora_Birth)
        debut = findViewById(R.id.UsadaPekora_Debut)
        height = findViewById(R.id.UsadaPekora_Height)
        gender = findViewById(R.id.UsadaPekora_Gender)
        profDesc = findViewById(R.id.UsadaPekora_ProfDesc)
