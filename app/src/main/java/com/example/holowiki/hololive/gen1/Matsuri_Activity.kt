...
class Matsuri_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen1/Natsuiro Matsuri/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_matsuri)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_matsuri)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.NatsuiroMatsuri_Name)
        ageView = findViewById(R.id.NatsuiroMatsuri_Age)
        birthday = findViewById(R.id.NatsuiroMatsuri_Birth)
        debut = findViewById(R.id.NatsuiroMatsuri_Debut)
        height = findViewById(R.id.NatsuiroMatsuri_Height)
        gender = findViewById(R.id.NatsuiroMatsuri_Gender)
        profDesc = findViewById(R.id.NatsuiroMatsuri_ProfDesc)
