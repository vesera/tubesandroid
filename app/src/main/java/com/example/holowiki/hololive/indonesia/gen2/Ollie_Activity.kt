...
class Ollie_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/ID Gen2/Kureiji Ollie/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ollie)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_ollie)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.KureijiOllie_Name)
        ageView = findViewById(R.id.KureijiOllie_Age)
        birthday = findViewById(R.id.KureijiOllie_Birth)
        debut = findViewById(R.id.KureijiOllie_Debut)
        height = findViewById(R.id.KureijiOllie_Height)
        gender = findViewById(R.id.KureijiOllie_Gender)
        profDesc = findViewById(R.id.KureijiOllie_ProfDesc)
