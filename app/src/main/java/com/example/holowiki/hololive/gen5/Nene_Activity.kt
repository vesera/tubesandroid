...
class Nene_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen5/Momosuzu Nene/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_nene)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_nene)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.MomosuzuNene_Name)
        ageView = findViewById(R.id.MomosuzuNene_Age)
        birthday = findViewById(R.id.MomosuzuNene_Birth)
        debut = findViewById(R.id.MomosuzuNene_Debut)
        height = findViewById(R.id.MomosuzuNene_Height)
        gender = findViewById(R.id.MomosuzuNene_Gender)
        profDesc = findViewById(R.id.MomosuzuNene_ProfDesc)
