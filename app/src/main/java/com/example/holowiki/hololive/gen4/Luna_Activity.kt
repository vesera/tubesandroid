...
class Luna_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen4/Himemori Luna/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_luna)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.HimemoriLuna_Name)
        ageView = findViewById(R.id.HimemoriLuna_Age)
        birthday = findViewById(R.id.HimemoriLuna_Birth)
        debut = findViewById(R.id.HimemoriLuna_Debut)
        height = findViewById(R.id.HimemoriLuna_Height)
        gender = findViewById(R.id.HimemoriLuna_Gender)
        profDesc = findViewById(R.id.HimemoriLuna_ProfDesc)
