...
class Shion_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen2/Murasaki Shion/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_shion)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_shion)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.MurasakiShion_Name)
        ageView = findViewById(R.id.MurasakiShion_Age)
        birthday = findViewById(R.id.MurasakiShion_Birth)
        debut = findViewById(R.id.MurasakiShion_Debut)
        height = findViewById(R.id.MurasakiShion_Height)
        gender = findViewById(R.id.MurasakiShion_Gender)
        profDesc = findViewById(R.id.MurasakiShion_ProfDesc)
