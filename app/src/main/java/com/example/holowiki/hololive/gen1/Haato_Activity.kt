...
class Haato_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen1/Akai Haato/Profile")

        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_haato)

        val toolbar: Toolbar = findViewById(R.id.toolbar_main)
        setSupportActionBar(toolbar)

        drawer = findViewById(R.id.drawer_layout_haato)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.AkaiHaato_Name)
        ageView = findViewById(R.id.AkaiHaato_Age)
        birthday = findViewById(R.id.AkaiHaato_Birth)
        debut = findViewById(R.id.AkaiHaato_Debut)
        height = findViewById(R.id.AkaiHaato_Height)
        gender = findViewById(R.id.AkaiHaato_Gender)
        profDesc = findViewById(R.id.AkaiHaato_ProfDesc)
