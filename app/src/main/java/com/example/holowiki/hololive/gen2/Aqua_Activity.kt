...
class Aqua_Activity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        val db_prof = FirebaseFirestore.getInstance().document("Hololive/Talents/Hololive/Gen2/Minato Aqua/Profile")
        ...
        drawer = findViewById(R.id.drawer_layout_aqua)
        toggle = ActionBarDrawerToggle(this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        talent_name = findViewById(R.id.MinatoAqua_Name)
        ageView = findViewById(R.id.MinatoAqua_Age)
        birthday = findViewById(R.id.MinatoAqua_Birth)
        debut = findViewById(R.id.MinatoAqua_Debut)
        height = findViewById(R.id.MinatoAqua_Height)
        gender = findViewById(R.id.MinatoAqua_Gender)
        profDesc = findViewById(R.id.MinatoAqua_ProfDesc)
